...
<div class="main-content">
	<section class="section">
		...
		<div class="section-body">
			...
			<form action="<?php echo base_url('pengaturan/edit'); ?>" method="post">
				<div class="row">
						...
						<div class="card card-primary">
							...
							<div class="card-body">
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" required <?php echo $readonlyAttribute; ?> name="nama_perusahaan" value="<?php echo ($pengaturan !== '') ? $pengaturan->nama_perusahaan : ''; ?>" class="form-control" placeholder="Nama Perusahaan" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" required <?php echo $readonlyAttribute; ?> name="telpon" value="<?php echo ($pengaturan !== '') ? $pengaturan->telpon : ''; ?>" class="form-control" maxlength="30" placeholder="No. Telpon" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="email" required <?php echo $readonlyAttribute; ?> name="email" value="<?php echo ($pengaturan !== '') ? $pengaturan->email : ''; ?>" class="form-control" id="inputEmail3" placeholder="Ketikan ulang password baru" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" <?php echo $readonlyAttribute; ?> name="fax" value="<?php echo ($pengaturan !== '') ? $pengaturan->fax : ''; ?>" class="form-control" maxlength="30" placeholder="Fax (Kosongkan jika tidak ada)" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" required <?php echo $readonlyAttribute; ?> name="website" value="<?php echo ($pengaturan !== '') ? $pengaturan->website : ''; ?>" class="form-control" maxlength="30" placeholder="Website" autocomplete="off">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<textarea name="alamat" required <?php echo $readonlyAttribute; ?> id="" cols="30" rows="10" class="form-control"><?php echo ($pengaturan !== '') ? $pengaturan->alamat : ''; ?></textarea>
                                        <?php echo form_error('website'); ?>
									</div>
								</div>
								<div class="col-sm-8 offset-3">
									...
									<?php else: ?>
										<a href="<?php echo base_url('pengaturan/edit'); ?>" class="btn btn-primary">Edit Data</a>
									<?php endif; ?>
								</div>
							</div>
						</div>
					...
					<div class="col-12 col-md-4 col-lg-4">
						<div class="card card-primary">
							...
							<div class="card-body text-center">
								<p class="mb-5">
									<img src="<?php echo ($pengaturan !== '') ? base_url($pengaturan->logo) : base_url('assets/img/stisla.svg'); ?>" alt="" class="img img-fluid" style="width: 220px;">
								</p>
...
<div class="modal fade" tabindex="-1" role="dialog" id="form-upload-modal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form action="<?php echo base_url('pengaturan/upload'); ?>" id="form-logo" method="POST" enctype="multipart/form-data">
