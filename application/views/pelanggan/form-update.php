                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="nama_pelanggan" value="<?php echo $pelanggan->nama_pelanggan; ?>" class="form-control text-uppercase" placeholder="Nama Pelanggan" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="alamat" required cols="30" rows="3" class="form-control text-uppercase" placeholder="Alamat"><?php echo $pelanggan->alamat; ?></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="kota" value="<?php echo $pelanggan->kota; ?>" class="form-control text-uppercase" placeholder="Kota" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required class="form-control text-uppercase" name="kontak" id="inputPassword3" placeholder="Kontak" value="<?php echo $pelanggan->kontak; ?>" autocomplete="off">
