                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="nama_pelanggan" value="<?php echo set_value('nama_pelanggan'); ?>" class="form-control text-uppercase" placeholder="Nama Pelanggan" autocomplete="off">
